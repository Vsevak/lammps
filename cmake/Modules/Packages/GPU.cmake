...
if(GPU_API STREQUAL "CUDA")
  ...
  target_compile_definitions(gpu PRIVATE -D_${GPU_PREC_SETTING} -DMPI_GERYON -DUCL_DEBUG ${GPU_CUDA_MPS_FLAGS})
  if(CUDPP_OPT)
...
elseif(GPU_API STREQUAL "OPENCL")
  ...
  set(OCL_TUNE_VALUES intel fermi kepler cypress vega generic)
